...
class BuildExe:
    def __init__(self):
        ...
        # 起始py文件
        self.script = "antworld.py"
        # 游戏名
        self.project_name = "antworld"
        # 游戏site
        self.project_url = "about:none"
        # 游戏版本
        self.project_version = "0.0"
        # 游戏许可
        self.license = "antworld License"
        # 游戏作者
        ...
        # 游戏描述
        self.project_description = "antworld Description"
        # 游戏图标(None的话使用pygame的默认图标)
        self.icon_file = None
        # 额外需要拷贝的文件、文件夹(图片，音频等)
        self.extra_datas = ['ant.png', 'leaf.png', 'spider.png']
        # 额外需要的python库名
        self.extra_modules = []
        # 需要排除的python库
